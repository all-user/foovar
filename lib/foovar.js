...
module.exports = function foovarFunc(outPath, options) {
  ...
  var codeStr = '(function() {\n  var FoovarValue = require(' + (TEST ? '\'' + _path2.default.resolve(process.cwd(), 'src/FoovarValue.js') + '\'' : '\'foovar/FoovarValue\'') + ');\n  var StylusExpression = require(' + (TEST ? '\'' + _path2.default.resolve(process.cwd(), 'src/StylusExpression.js') + '\'' : '\'foovar/StylusExpression\'') + ');\n\n  module.exports = {\n' + body + '\n  };\n})();';
