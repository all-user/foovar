...
module.exports = function foovarFunc(outPath, options) {
  ...
  var codeStr = '(function(){var F=require(' + (TEST ? '\'' + _path2.default.resolve(process.cwd(), 'src/FoovarValue.js') + '\'' : '\'foovar/lib/FoovarValue\'') + ');var S=require(' + (TEST ? '\'' + _path2.default.resolve(process.cwd(), 'src/StylusExpression.js') + '\'' : '\'foovar/lib/StylusExpression\'') + ');module.exports={' + (comp ? '' : '\n') + body + '};})();';
