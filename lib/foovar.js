...
module.exports = function foovarFunc(outPath, options) {
  ...
  var _optionsResolver = optionsResolver(options),
      ...
      propertyCase = _optionsResolver.propertyCase;
  ...
  _FoovarValue2.default.case = propertyCase && propertyCase.val;
  ...
  var setPropertyCase = FoovarValueCase ? 'F.case=' + FoovarValueCase + ';' : '';
