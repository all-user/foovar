...
describe('export false var:', () => {
  ...
  it('value', () => {
    assert.strictEqual(vars.varName(), false);
  });

  it('typeof', () => {
    assert.strictEqual(typeof vars.varName(), 'boolean');
  });

  it('stylus node type', () => {
    assert.strictEqual(vars.varName.type, 'boolean');
  });
